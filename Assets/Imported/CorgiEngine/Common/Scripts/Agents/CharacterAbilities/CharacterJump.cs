...
{	
	...
	{	
		...
		{
			if (!GetComponent<Controls> ().photonView.isMine) {
				return;
			}
		...
		protected virtual bool EvaluateJumpConditions()
		{
			...
			if (_characterButtonActivation != null)
			{
				...
				{
					//Allow player to still jump on signs...
		...
		public void SetJumpAnywhere()
		{
			JumpRestrictions = JumpBehavior.CanJumpAnywhereAnyNumberOfTimes;
		}

		public void SetJumpOnGround()
		{
			JumpRestrictions = JumpBehavior.CanJumpOnGround;
		}

		public void SetJumpAnywhereTwice()
		{
			JumpRestrictions = JumpBehavior.CanJumpAnywhere;
		}
	}
}
