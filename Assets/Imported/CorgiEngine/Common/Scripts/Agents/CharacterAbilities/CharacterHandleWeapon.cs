...
{	
	...
	public class CharacterHandleWeapon : CharacterAbility 
	{
		...
		public virtual void ShootStart()
		{
			...
			GetComponent<PhotonView> ().photonView.RPC ("ClientSend", PhotonTargets.All,true);
		...
		public virtual void ShootStop()
		{
			...
			GetComponent<PhotonView> ().photonView.RPC ("ClientSend", PhotonTargets.All,false);
		...
		[PunRPC]
		public void ClientSend (bool active)
		{
			if (CurrentWeapon != null) {
				if (active) {
					CurrentWeapon.WeaponInputStart ();
