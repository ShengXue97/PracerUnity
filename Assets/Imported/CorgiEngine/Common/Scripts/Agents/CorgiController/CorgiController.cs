	...
	public class CorgiController : MonoBehaviour 
	{
		...
		protected virtual void ApplyGravity()
		{
			if (GetComponent<Controls>() != null) {
				_currentGravity = GetComponent<Controls> ().CurrentGravity;
			}
		...
		public void DisableCollisionsNoTimer()
		{
			CollisionsOff();
		}

		public void EnableeCollisionsNoTimer()
		{
			CollisionsOn();
		}
		...
		public bool IsCollingTop()
		{
			return State.IsCollidingAbove;
		}

		public bool IsCollingBottom()
		{
			return State.IsCollidingBelow;
		}

		public bool IsCollingLeft()
		{
			return State.IsCollidingLeft;
		}

		public bool IsCollingRight()
		{
			return State.IsCollidingRight;
		}

		public void SetCollidingBelow()
		{
			State.IsCollidingBelow = true;
			State.JustGotGrounded = true;
			State.WasGroundedLastFrame = true;
		}
	}
}