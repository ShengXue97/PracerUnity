...
{	
	...
	public class PathedProjectileSpawner : MonoBehaviour 
	{
	    ...
	    protected virtual void Start () 
		{
			...
			Destination = transform.position + new Vector3 (20000f, 0f, 0f);
		}
	    ...
	    protected virtual void Update () 
		{
			...
			_nextShotInSeconds = FireRate;
			var projectile = (PathedProjectile) Instantiate(Projectile, transform.position + new Vector3(1.5f,0f,0f),transform.rotation);
			projectile.Initialize(Destination,Speed);
			if (SpawnEffect!=null)
			{
				Instantiate(SpawnEffect,transform.position + new Vector3(1.5f,0f,0f),transform.rotation);
			}
		}
